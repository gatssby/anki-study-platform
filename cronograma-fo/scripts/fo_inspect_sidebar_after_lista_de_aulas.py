...
with sync_playwright() as p:
    ...
    res1 = click_smallest_visible_text(page, "Lista de aulas")
    print("Resultado:", res1)
    page.wait_for_timeout(2000)

    print("Abrindo Aulas Gerais...")
    res2 = click_smallest_visible_text(page, "Aulas Gerais")
    ...
    print("\\nElementos visíveis depois de Lista de aulas + Aulas Gerais:")
    for row in data:
