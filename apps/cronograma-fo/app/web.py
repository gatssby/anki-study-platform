...
def serialize_report(report) -> dict[str, object]:
    return {
        ...
        "remaining_lessons_by_track": report.remaining_lesson_count_by_track,
        "distributed_lessons_by_track": report.distributed_lesson_count_by_track,
        ...
        "configured_daily_minutes_informational": True,
        "overflow_days": report.overflow_days,
        "daily_goal_units": round(report.required_average_units, 2),
        "average_lessons_per_day": round(report.average_lessons_per_day, 2),
        "average_minutes_per_day": round(report.average_minutes_per_day, 2),
        "max_daily_load_units": report.max_daily_load_units,
        "min_daily_load_units": report.min_daily_load_units,
