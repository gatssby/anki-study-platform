...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--operations-days", type=float, default=30, help="Age threshold for finalized operations.")
...
def print_section(name: str, directory_label: str, candidates: list[Candidate], scanned: int, apply: bool) -> int:
...
def main() -> int:
    ...
    if args.keep_generations < 2:
        ...
        return 2
    if any(value < 0 for value in (args.logs_days, args.operations_days, args.media_temp_days)):
